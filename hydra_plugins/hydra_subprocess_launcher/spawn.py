"""
Based on: https://github.com/pytorch/pytorch/blob/main/torch/multiprocessing/spawn.py.
We use this implementation because it could handle errors raised in child process.
Remove `_prctl_pr_set_pdeathsig`.
"""
